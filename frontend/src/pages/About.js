...
const About = () => {
  ...
  return (
    <div className=" reddit-sans">
      <Navbar />
      <div className=" pt-10 mx-2 md:mx-14 lg:mx-32">
        <div className=" flex justify-center">
          <p className="font-semibold text-3xl underline-text">ABOUT</p>
        </div>
        <div className=" pt-12 gap-20 items-center md:flex ">
          <img className=" h-52 md:h-96 w-auto" src={AboutPic}></img>
          <div>
            <div className=" flex">
              <p className=" flex justify-center orange-text text-3xl md:text-6xl font-semibold">
                Your Star Determines <br /> Your Life's Journey
              </p>
              <img
                className=" h-44 hidden md:flex absolute right-0"
                src={Saturn}
              ></img>
            </div>
            <p className=" pt-6 mr-24">
        ...
        <div className=" md:flex justify-between pt-6">
          <a className=" flex items-center hover:cursor-pointer hover:underline">
            ...
            <p className=" text-base md:text-xl font-medium">+91 9876543210</p>
          </a>
          <a className=" flex items-center hover:cursor-pointer hover:underline">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a className=" flex items-center hover:cursor-pointer hover:underline">
            ...
            <p className=" text-base md:text-xl font-medium">astronomica.in</p>
          </a>
          <a className=" flex items-center hover:cursor-pointer hover:underline">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className=" pt-16 md:flex justify-between">
          <div className=" w-[40%]">
        ...
        <div className=" pt-16">
          ...
          <img
            className="hidden md:flex absolute right-0 h-44"
            src={FAQImg}
          ></img>
