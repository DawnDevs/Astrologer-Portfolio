...
const NumberRow = () => {
  ...
  return (
    <div className='relative'>
      <div className='md:ml-[36%] absolute md:top-[-60%] lg:top-[-60%]'>
        <img src={star} width={200} height={200} alt="Star" />
      </div>
      <div className='flex md:top-0' ref={ref}>
        <div className='bg-amber-500 text-center px-2 py-2 sm:px-[3%] md:px-[3%] md:py-[3%] lg:px-[4%] lg:py-4 xl:px-[6%] xl:py-4'>
